...
class ewdotpView extends ewdotpBase {
	...
	public function add_custom_styling() {
		...
		echo '<style>';
			if ( $ewd_otp_controller->settings->get_setting( 'styling-title-font' ) != '' ) { echo '.ewd-otp-order-tracking-form-div h3 { font-family: ' . $ewd_otp_controller->settings->get_setting( 'styling-title-font' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-title-font-size' ) != '' ) { echo '.ewd-otp-order-tracking-form-div h3 { font-size: ' . $ewd_otp_controller->settings->get_setting( 'styling-title-font-size' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-title-font-color' ) != '' ) { echo '.ewd-otp-order-tracking-form-div h3 { color: ' . $ewd_otp_controller->settings->get_setting( 'styling-title-font-color' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-title-margin' ) != '' ) { echo '.ewd-otp-order-tracking-form-div h3 { margin: ' . $ewd_otp_controller->settings->get_setting( 'styling-title-margin' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-title-padding' ) != '' ) { echo '.ewd-otp-order-tracking-form-div h3 { padding: ' . $ewd_otp_controller->settings->get_setting( 'styling-title-padding' ) . ' !important; }'; }

			if ( $ewd_otp_controller->settings->get_setting( 'styling-label-font' ) != '' ) { echo '.ewd-otp-tracking-results-label { font-family: ' . $ewd_otp_controller->settings->get_setting( 'styling-label-font' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-label-font-size' ) != '' ) { echo '.ewd-otp-tracking-results-label { font-size: ' . $ewd_otp_controller->settings->get_setting( 'styling-label-font-size' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-label-font-color' ) != '' ) { echo '.ewd-otp-tracking-results-label { color: ' . $ewd_otp_controller->settings->get_setting( 'styling-label-font-color' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-label-margin' ) != '' ) { echo '.ewd-otp-tracking-results-label { margin: ' . $ewd_otp_controller->settings->get_setting( 'styling-label-margin' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-label-padding' ) != '' ) { echo '.ewd-otp-tracking-results-label { padding: ' . $ewd_otp_controller->settings->get_setting( 'styling-label-padding' ) . ' !important; }'; }

			if ( $ewd_otp_controller->settings->get_setting( 'styling-content-font' ) != '' ) { echo '.ewd-otp-tracking-results-value { font-family: ' . $ewd_otp_controller->settings->get_setting( 'styling-content-font' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-content-font-size' ) != '' ) { echo '.ewd-otp-tracking-results-value { font-size: ' . $ewd_otp_controller->settings->get_setting( 'styling-content-font-size' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-content-font-color' ) != '' ) { echo '.ewd-otp-tracking-results-value { color: ' . $ewd_otp_controller->settings->get_setting( 'styling-content-font-color' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-content-margin' ) != '' ) { echo '.ewd-otp-tracking-results-value { margin: ' . $ewd_otp_controller->settings->get_setting( 'styling-content-margin' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-content-padding' ) != '' ) { echo '.ewd-otp-tracking-results-value { padding: ' . $ewd_otp_controller->settings->get_setting( 'styling-content-padding' ) . ' !important; }'; }

			if ( $ewd_otp_controller->settings->get_setting( 'styling-button-font-color' ) != '' ) { echo '.ewd-otp-submit { color: ' . $ewd_otp_controller->settings->get_setting( 'styling-button-font-color' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-button-background-color' ) != '' ) { echo '.ewd-otp-submit { background-color: ' . $ewd_otp_controller->settings->get_setting( 'styling-button-background-color' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-button-border' ) != '' ) { echo '.ewd-otp-submit { border: ' . $ewd_otp_controller->settings->get_setting( 'styling-button-border' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-button-margin' ) != '' ) { echo '.ewd-otp-submit { margin: ' . $ewd_otp_controller->settings->get_setting( 'styling-button-margin' ) . ' !important; }'; }
			if ( $ewd_otp_controller->settings->get_setting( 'styling-button-padding' ) != '' ) { echo '.ewd-otp-submit { padding: ' . $ewd_otp_controller->settings->get_setting( 'styling-button-padding' ) . ' !important; }'; }

			echo $ewd_otp_controller->settings->get_setting( 'custom-css' );
