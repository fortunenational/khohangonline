...
<div class='ewd-otp-tracking-graphic ewd-otp-<?php echo $graphic_type; ?>'>
	...
	<div class='ewd-otp-full-display' style='width:<?php echo $this->order->current_status->percentage; ?>%'>
