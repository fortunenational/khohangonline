...
class ewdotpInstallationWalkthrough {
	...
	public function admin_enqueue() {
		...
		wp_enqueue_style( 'ewd-otp-admin-css', EWD_OTP_PLUGIN_URL . '/assets/css/admin.css', array(), EWD_OTP_VERSION );
							...
							<tbody>
								<?php foreach ( $statuses as $key => $status) { ?>
									<tr class="list-item edit-status-item">
										<td class="status"><input type='text' class='ewd-otp-welcome-edit-status-input' name='status[]' value='<?php echo esc_attr( $status->status ); ?>' /></td>
										<td class="status-completed"><input type='text' class='ewd-otp-welcome-edit-status-input ewd-otp-edit-status-percentage-input' name='status_percentages[]' value='<?php echo esc_attr( $status->percentage ); ?>' /></td>
									</tr>	
								<?php } ?>
							</tbody>
						...
						<tr>
							...
							<td class='ewd-otp-welcome-screen-option'>
								<fieldset>
									...
									<label for='form_instructions'></label><textarea class='ewd-otp-textarea' name='form_instructions'> <?php echo $form_instructions; ?></textarea><br />
