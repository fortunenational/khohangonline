...
class ewdotpCustomersTable extends WP_List_Table {
	...
	public function query_string_maintenance() {
		...
		$this->filter_customer_email = ! isset( $_GET['customer_email'] ) ? '' : sanitize_text_field( $_GET['customer_email'] );
		$this->filter_customer_email = ! isset( $_POST['customer_email'] ) ? $this->filter_customer_email : sanitize_text_field( $_POST['customer_email'] );
	...
	public function process_bulk_action() {
		...
		$ids    = isset( $_POST['customers'] ) ? $_POST['customers'] : false;
