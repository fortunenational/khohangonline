...
class ewdotpImport {
	...
	public function enqueue_import_scripts() {
		...
		if ( $screen->id == 'ewd-otp-tracking_page_ewd-otp-import' ) {

			wp_enqueue_style( 'ewd-otp-admin-css', EWD_OTP_PLUGIN_URL . '/assets/css/ewd-otp-admin.css', array(), '3.0.0' );
			wp_enqueue_script( 'ewd-otp-admin-js', EWD_OTP_PLUGIN_URL . '/assets/js/ewd-otp-admin.js', array( 'jquery' ), '3.0.0', true );
		}
	}
