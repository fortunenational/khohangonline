...
class ewdotpDashboard {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_ewd_otp_hide_upgrade_box', array($this, 'hide_upgrade_box') );
		add_action( 'wp_ajax_ewd_otp_display_upgrade_box', array($this, 'display_upgrade_box') );
	}
	...
	public function enqueue_scripts() {
		...
		if ( $currentScreen->id == 'tracking_page_ewd-otp-dashboard' ) {
