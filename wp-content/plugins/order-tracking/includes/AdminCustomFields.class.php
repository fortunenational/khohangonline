...
class ewdotpAdminCustomFields {
			...
			<form id="ewd-otp-custom-fields-table" method="POST" action="">
				...
				<div id='ewd-otp-custom-fields-table-div'>
					...
					<div class='ewd-otp-custom-fields-add'>
						<?php _e( '&plus;&nbsp;ADD', 'order-tracking' ); ?>
					</div>
	...
	public function enqueue_scripts() {
		...
		if ( $screen->id == 'tracking_page_ewd-otp-custom-fields' ) {

			wp_enqueue_style( 'ewd-otp-admin-css', EWD_OTP_PLUGIN_URL . '/assets/css/ewd-otp-admin.css', array(), EWD_OTP_VERSION );
			wp_enqueue_script( 'ewd-otp-admin-js', EWD_OTP_PLUGIN_URL . '/assets/js/ewd-otp-admin.js', array( 'jquery', 'jquery-ui-sortable' ), EWD_OTP_VERSION, true );
		}
	}
}
} // endif;
