...
if ( !class_exists( 'ewdotpAJAX' ) ) {
	...
	class ewdotpAJAX {
		...
		public function get_customer_orders() {
			...
			if ( $ewd_otp_controller->settings->get_setting( 'email-verification' ) and ! $customer->verify_order_email( sanitize_email( $_POST['customer_email'] ) ) ) { 
		...
		public function get_sales_rep_orders() {
			...
			if ( $ewd_otp_controller->settings->get_setting( 'email-verification' ) and ! $sales_rep->verify_order_email( sanitize_email( $_POST['sales_rep_email'] ) ) ) { 
