jQuery(document).ready(function() {
	...
	jQuery('.ewd-otp-welcome-screen-add-status-button').on('click', function() {
		...
		var data = 'status_name=' + status_name + '&status_percentage=' + status_percentage + '&action=ewd_otp_welcome_add_status';
	...
	jQuery('.ewd-otp-welcome-screen-save-options-button').on('click', function() {
		...
		var data = 'order_information=' + JSON.stringify(order_information) + '&email_frequency=' + email_frequency + '&form_instructions=' + form_instructions + '&hide_blank_fields=' + hide_blank_fields + '&action=ewd_otp_welcome_set_options';
		jQuery.post(ajaxurl, data, function(response) {
