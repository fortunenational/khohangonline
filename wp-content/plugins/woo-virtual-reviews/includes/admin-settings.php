...
class Admin_Settings {
	...
	public function admin_menu() {
		...
		add_submenu_page(
			'virtual-reviews',
			__( 'Settings', 'woo-virtual-reviews' ),
			__( 'Settings', 'woo-virtual-reviews' ),
			'manage_woocommerce',
			'wvr_settings',
	...
	public function page_settings_content() {
        ...
        <div>
            ...
            <form method="post" class="vi-ui form segment">
				<?php wp_nonce_field( 'wvr_nonce', 'wvr_nonce' ) ?>
                <h4><?php esc_html_e( 'General', 'woo-virtual-reviews' ); ?></h4>
				<?php Setting_Row::output_fields( $general ); ?>
                <hr>
                <h4><?php esc_html_e( 'Frontend', 'woo-virtual-reviews' ); ?></h4>
        ...
        <div class="wvr-wrapper">
            ...
            <div id="wvr-review-from-setting" class="vi-ui segment form small">
                ...
                <div class="field">
					...
					<?php
					wc_product_dropdown_categories( array( 'class' => 'wvr-product-cat', 'show_option_none' => false ) );
					?>
                </div>
	...
	public function save_option() {
		if ( ! current_user_can( 'manage_woocommerce' ) || ! isset( $_POST['wvr_nonce'] ) || ! wp_verify_nonce( $_POST['wvr_nonce'], 'wvr_nonce' ) || empty( $_POST['wvr_save_settings'] ) ) {
			return;
		}
