<form method="post" action="options.php">
	...
	<table class="form-table">
		...
		<th scope="row"><?php _e( 'Point of Orgin', 'wpcargo-pod' ); ?></th>
			<td>
				<input type="hidden" name="shmap_longitude" id="shmap_longitude" value="<?php echo $shmap_longitude; ?>">
				<input type="hidden" name="shmap_latitude" id="shmap_latitude" value="<?php echo $shmap_latitude; ?>">
				<input style="min-width: 400px;" type="text" name="shmap_origin_marker" id="shmap_origin_marker" value="<?php echo $shmap_origin_marker; ?>" required>
